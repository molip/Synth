...
ModuleTypes::ModuleTypes()
{
	...
	_types.back().AddInput(std::make_unique<PinType>("sust", "Sustain", PinType::ConnectionType::Single, Engine::Pin::Envelope::Input::Sustain)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	...
	_types.back().AddInput(std::make_unique<PinType>("wave", "Waveform", PinType::ConnectionType::Single, Engine::Pin::Oscillator::Input::Waveform)).SetValueType(std::make_unique<IntValueType>(0, 0, 3));
	_types.back().AddInput(std::make_unique<PinType>("ptch", "Pitch", PinType::ConnectionType::Single, Engine::Pin::Oscillator::Input::Pitch)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	_types.back().AddInput(std::make_unique<PinType>("levl", "Level", PinType::ConnectionType::Single, Engine::Pin::Oscillator::Input::Level)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	...
	_types.back().AddInput(std::make_unique<PinType>("freq", "Frequency", PinType::ConnectionType::Single, Engine::Pin::Filter::Input::Frequency)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	_types.back().AddInput(std::make_unique<PinType>("resn", "Resonance", PinType::ConnectionType::Single, Engine::Pin::Filter::Input::Resonance)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	...
	_types.back().AddInput(std::make_unique<PinType>("mini", "Minimum", PinType::ConnectionType::Single, Engine::Pin::Range::Input::Minimum)).SetValueType(std::make_unique<PercentValueType>(0));
	_types.back().AddInput(std::make_unique<PinType>("maxi", "Maximum", PinType::ConnectionType::Single, Engine::Pin::Range::Input::Maximum)).SetValueType(std::make_unique<PercentValueType>(0xffff));
	...
	_types.back().AddInput(std::make_unique<PinType>("shft", "Shift", PinType::ConnectionType::Single, Engine::Pin::PitchShift::Input::Shift)).SetValueType(std::make_unique<IntValueType>(0, -127, 127));
	...
	_types.back().AddInput(std::make_unique<PinType>("wave", "Waveform", PinType::ConnectionType::Single, Engine::Pin::LFO::Input::Waveform)).SetValueType(std::make_unique<IntValueType>(0, 0, 3));
	_types.back().AddInput(std::make_unique<PinType>("ptch", "Pitch", PinType::ConnectionType::Single, Engine::Pin::LFO::Input::Pitch)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	_types.back().AddInput(std::make_unique<PinType>("levl", "Level", PinType::ConnectionType::Single, Engine::Pin::LFO::Input::Level)).SetValueType(std::make_unique<PercentValueType>(0xffff));
	_types.back().AddInput(std::make_unique<PinType>("duty", "Duty", PinType::ConnectionType::Single, Engine::Pin::LFO::Input::Duty)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	...
	_types.back().AddInput(std::make_unique<PinType>("fbck", "Feedback", PinType::ConnectionType::Single, Engine::Pin::Delay::Input::Feedback)).SetValueType(std::make_unique<PercentValueType>(0x8000));
	...
	_types.back().AddInput(std::make_unique<PinType>("octa", "Octaves", PinType::ConnectionType::Single, Engine::Pin::Arpeggiator::Input::Octaves)).SetValueType(std::make_unique<IntValueType>(1, 1, 8));
